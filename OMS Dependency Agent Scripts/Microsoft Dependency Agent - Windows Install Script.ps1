...
#Select-AzureRmSubscription -SubscriptionName "JB-Production" -TenantId "d9217073-9527-487c-9687-b6bbd93ed621"
#Select-AzureRmSubscription -SubscriptionName "JB-Resource" -TenantId "d9217073-9527-487c-9687-b6bbd93ed621"
#endregion
...
#Removes the ARM Custom Script Extension that installs the Microsoft Dependency Agent for Windows
    ...
    remove-AzureRmVMCustomScriptExtension -ResourceGroupName JB-RG-DOMAINCONTROLLERS-EASTUS2 `
    -VMName 'jbazdc04' `
